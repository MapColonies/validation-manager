...
import { INGESTION_ROUTER_SYMBOL } from './validation/routes/validationRouter';
...
export class ServerBuilder {
  ...
  public constructor(
    ...
    @inject(INGESTION_ROUTER_SYMBOL) private readonly validationRouter: Router,
  ) {
  ...
  private buildRoutes(): void {
    this.serverInstance.use('/', this.validationRouter);

...
import { BoundingRegion, BoundingSphere, TileSetJson } from '../../../../src/common/interfaces';
import * as polygonCalculates from '../../../../src/validation/models/calculatePolygonFromTileset';
